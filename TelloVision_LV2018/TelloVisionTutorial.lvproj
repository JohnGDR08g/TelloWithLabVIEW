...
<Project Type="Project" LVVersion="18008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Tello" Type="Folder">
			<Property Name="NI.SortType" Type="Int">3</Property>
			<Item Name="Vision" Type="Folder">
				<Item Name="PythonNodeForTelloVideoTester.vi" Type="VI" URL="../PythonNodeForTelloVideoTester.vi"/>
			</Item>
			<Item Name="Function" Type="Folder">
				<Item Name="UDPSingleCommandSender.vi" Type="VI" URL="../UDPSingleCommandSender.vi"/>
				<Item Name="UDPStateReceiver.vi" Type="VI" URL="../UDPStateReceiver.vi"/>
			</Item>
			...
			<Item Name="Example" Type="Folder">
				...
				<Item Name="TelloDemoExample.vi" Type="VI" URL="../TelloDemoExample.vi"/>
			</Item>
			<Item Name="SubVI" Type="Folder">
				<Item Name="2ComboKeyDetect (SubVI).vi" Type="VI" URL="../Library/Remote Control/2ComboKeyDetect (SubVI).vi"/>
				<Item Name="Simple UDP Message.lvlib" Type="Library" URL="../Library/Simple UDP Message/Simple UDP Message.lvlib"/>
			</Item>
		</Item>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="ExtImgFGV.vi" Type="VI" URL="../VisionFGV/ExtImgFGV.vi"/>
			<Item Name="fgvExp.vi" Type="VI" URL="../VisionFGV/fgvExp.vi"/>
